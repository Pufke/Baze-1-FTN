...
void fromTxtToSerailFile(FILE *pFtxt, FILE *pFbin);
...
int main() {
    ...
    while (option) {
        ...
        case 7:
            ...
            fromTxtToSerailFile(pInputTxtFile, pInputSerialFile);
...
void fromTxtToSerailFile(FILE *pInputTxtFile, FILE *pOutputSerialFile) {
    Record r;
