...
public class Pozoriste {
	...
	public Pozoriste(int id, String naziv, String adresa, String sajt,int mesto) {
		this.id = id;
		this.naziv = naziv;
		this.adresa = adresa;
		this.sajt = sajt;
	...
	public boolean equals(Object obj) {
		...
		if (id != other.id)
			return false;
		/*
		 * if (mesto == null) { if (other.mesto != null) return false; } else if
		 * (!mesto.equals(other.mesto)) return false;
		 */
		if (naziv == null) {
			if (other.naziv != null)
				return false;
